...
const blogSchema = Joi.object({
    title: Joi.object({
      en: Joi.string().required().min(1).max(120).messages({
      ...
      ar: Joi.string().required().min(1).max(120).messages({
    ...
    content: Joi.object({
      en: Joi.string().required().min(1).max(5000).messages({
      ...
      ar: Joi.string().required().min(1).max(5000).messages({
    ...
    caption: Joi.object({
      en: Joi.string().required().min(1).max(180).messages({
      ...
      ar: Joi.string().required().min(1).max(180).messages({
